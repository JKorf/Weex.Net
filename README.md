# ![Weex.Net](https://raw.githubusercontent.com/JKorf/Weex.Net/main/Weex.Net/Icon/icon.png) Weex.Net  
...
[![Docs](https://img.shields.io/badge/Docs-Weex.Net-1b7f50?style=for-the-badge)](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Weex.Net)
...
The [Weex.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Weex.Net) is the main resource for installing, configuring, and using the library.

| Resource | Description |
|--|--|
| [Client guide](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Weex.Net) | Installation, REST and WebSocket clients, authentication, dependency injection, error handling, and advanced features |
| [Examples](https://cryptoexchange.jkorf.dev/docs/exchange-clients/examples?library=Weex.Net) | Common REST and WebSocket operations |
| [API reference](https://cryptoexchange.jkorf.dev/docs/exchange-clients/reference?library=Weex.Net) | Client interfaces, methods, and properties |
...
### NuGet 
[![NuGet version](https://img.shields.io/nuget/v/Weex.net.svg?style=for-the-badge)](https://www.nuget.org/packages/Weex.Net)  [![Nuget downloads](https://img.shields.io/nuget/dt/Weex.Net.svg?style=for-the-badge)](https://www.nuget.org/packages/Weex.Net)

	dotnet add package Weex.Net
	
### GitHub packages
Weex.Net is available on [GitHub packages](https://github.com/JKorf/Weex.Net/pkgs/nuget/Weex.Net). You'll need to add `https://nuget.pkg.github.com/JKorf/index.json` as a NuGet package source.

### Download release
[![GitHub Release](https://img.shields.io/github/v/release/JKorf/Weex.Net?style=for-the-badge&label=GitHub)](https://github.com/JKorf/Weex.Net/releases)

The NuGet package files are added along side the source with the latest GitHub release which can found [here](https://github.com/JKorf/Weex.Net/releases).
...
For more examples and explanations, continue with the [Weex.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=Weex.Net) or browse the [compilable repository examples](https://github.com/JKorf/Weex.Net/tree/main/Examples).
...
|File|Purpose|
|--|--|
|[`AGENTS.md`](AGENTS.md)|Assistant skill with core Weex.Net patterns, pitfalls, and examples|
...
V2 uses a strict interface per capability. The `SharedApi` property on each API surface therefore exposes only the operations or subscriptions that surface actually supports. `IWeexSharedApiClient` groups the exchange's Shared API surfaces for dependency injection and runtime capability lookup.
...
using var restClient = new WeexRestClient();
...
The request and response models belong to `CryptoExchange.Net.SharedApis`, so the same operation can accept another exchange's `IGetTickerRest` implementation. When using dependency injection, inject `IWeexSharedApiClient` to access all of the exchange's Shared API surfaces or inject a capability such as `IGetTickerRest` directly. Use `GetCapability` on the aggregate when the operation, transport, or trading mode is selected at runtime.
...
## Release notes
* Version 2.5.0 - 24 Sep 2026
    * Updated CryptoExchange.Net to v13.0.0
    * Shared APIs
      * Added SharedApi V2 support
      * Added `.SharedApi` property to clients
      * Added `(I)WeexSharedApiClient` containing all V2 SharedApi references
      * Added `SharedApi` to `WeexOptions` to provide SharedApi related options
    ...
    * Added reduceOnly parameter to Futures PlaceOrderAsync and PlaceConditionalOrderAsync endpoints
    * Added nextKeyId, nextKeyTime parameters to GetAccountBillsAsync endpoints
    * Fixed WeexFuturesBill NextKey deserialization

* Version 2.4.0 - 21 Aug 2026
    * Updated to CryptoExchange.Net v12.5.0
    * Added MakerFeePercentage, TakerFeePercentage, LowerPriceLimitPercentage, UpperPriceLimitPercentage to SharedSpotSymbol mapping
    * Added MakerFeePercentage, TakerFeePercentage, LowerPriceLimitPercentage, UpperPriceLimitPercentage, MaxShortLeverage, MaxLongLeverage to SharedFuturesSymbol mapping

* Version 2.3.0 - 29 Jul 2026
...
* Version 2.1.1 - 13 Jul 2026
    * Updated SocketUpdateType setting for SubscribeToTradeUpdatesAsync updates
    * Fixed WeexSubscription IndividualSubscriptionCount not being set correctly

* Version 2.1.0 - 09 Jul 2026
    * Updated CryptoExchange.Net to v12.1.0
    * Added RateLimits to WeexExchangeInfo and WeexFuturesExchangeInfo models
    * Added NextKey property to WeexFuturesBillPage model
...
* Version 2.0.0 - 29 Jun 2026
    ...
    * Added setter to WeexExchange.RateLimiter to allow custom rate limit settings
