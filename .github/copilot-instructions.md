...
For detailed patterns and pitfalls see `CLAUDE.md`, `llms.txt`, and `llms-full.txt` in the repository root. See `docs/ai-api-map.md` for the intent-to-method table and `Examples/ai-friendly/` for compilable examples.
