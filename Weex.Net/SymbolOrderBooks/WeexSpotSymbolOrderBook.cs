...
namespace Weex.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class WeexSpotSymbolOrderBook : SymbolOrderBook
    {
        ...
        public WeexSpotSymbolOrderBook(string symbol, Action<WeexOrderBookOptions>? optionsDelegate = null)
        ...
        public WeexSpotSymbolOrderBook(
            string symbol,
            Action<WeexOrderBookOptions>? optionsDelegate,
            ILoggerFactory? logger,
            IWeexRestClient? restClient,
            IWeexSocketClient? socketClient) : base(logger, "Weex", "Spot", symbol)
        {
