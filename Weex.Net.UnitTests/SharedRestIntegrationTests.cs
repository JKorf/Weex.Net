...
namespace Weex.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IWeexRestClientSpotApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddWeex(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IWeexRestClient>().SpotApi.SharedClient;
        }

        private IWeexRestClientFuturesApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddWeex(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IWeexRestClient>().FuturesApi.SharedClient;
        }
